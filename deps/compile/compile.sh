...
# compile wrapper
g++ -Wall -fPIC -c odr_manager_wrapper.cpp -L../lib/Linux/lib64 -lODriveLite.1.4.3
...
mv libodrmanjl.so.1.0 libodrmanjl.so
# mv libodrmanjl.so.1.0 ../../deps/downloads/libsmilejl.so