...
extern "C" void odr_manager_activatePosition(void * void_odr_manager, Position * pos);
...
extern "C" void odr_manager_setpos_track_coord(void * void_odr_manager, TrackCoord * value);
extern "C" void odr_manager_set_track_pos_s_t(void * void_odr_manager, int * id, double * s, double * t=0.0);
extern "C" void odr_manager_set_track_pos_track_coord(void * void_odr_manager, TrackCoord * value);
extern "C" void odr_manager_setpos_lane_coord(void * void_odr_manager, LaneCoord * value);
extern "C" void odr_manager_setLanePos(void * void_odr_manager, int * trackId, int * laneId, double * s, double * offset = 0.0);
extern "C" void odr_manager_setLanePos(void * void_odr_manager, LaneCoord * value);
extern "C" void odr_manager_setpos_coord(void * void_odr_manager, Coord * value);
...
extern "C" void odr_manager_print(void * void_odr_manager, int ident=0);
