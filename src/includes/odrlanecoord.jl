...
intitialize_lanecoord(mgr::OdrManagerLite, coord::LaneCoord) =
    ccall((:lane_coord_initialize, LIB_ODRMGR), Void, (Ptr{Void}, Ptr{LaneCoord},), mgr.ptr, pointer_from_objref(coord))
