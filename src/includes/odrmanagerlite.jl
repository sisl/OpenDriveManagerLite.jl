...
set_trackpos_s_t(mgr::OdrManagerLite, id::Int, s::Real, t::Real=0.0) =
    ccall((:odr_manager_set_track_pos_s_t, LIB_ODRMGR), Void, (Ptr{Void}, Ptr{Int}, Real, Real), mgr.ptr, id, s, t)
